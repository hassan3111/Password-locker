...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_credential = Credentials('Hassan','Facebook','234567')
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credential.user_name,"Hassan")
    ...
    def test_delete_credentials(self):
        ...
        '''
        self.new_credential.save_credentials()
        test_credential = Credentials("Hassan","Facebook","234567") # new credential
    ...
    def test_save_multiple_credential(self):
            ...
            '''
            self.new_credential.save_credentials()
            test_credential = Credentials("Hassan","Facebook","2345678") # new credential
            test_credential.save_credentials()
